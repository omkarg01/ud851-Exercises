...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDefinationTV = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        if (mData != null) {
            ...
            mDefinationTV.setVisibility(View.INVISIBLE);
            ...
            mDefinationTV.setText(mData.getString(mDefCol));
    ...
    public void showDefinition() {
        ...
        if (mData != null) {
            ...
            mDefinationTV.setVisibility(View.VISIBLE);
